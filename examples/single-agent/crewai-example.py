...
Observe.init(app_name="research_writing_crew", api_endpoint=os.getenv("OTLP_HTTP_ENDPOINT", "http://localhost:4318"))
...
@tool(name="summarize_findings")
@crewai_tool("summarize_findings")
